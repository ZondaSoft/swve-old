...
class DiagnosController extends Controller
{
    ...
    public function index($id = 0)
    {
        ...
        return view('diagnos.index')->with(compact('legajo','agregar','edicion','active'));
    }


    public function add()
    {
        $legajo = new Sue058;      // find($id);     // dd($legajo);
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            'codigo'=>'required|unique:sue058s',
            'detalle'=>'required'
            ];
    ...
    public function edit($id)
    {
        ...
        return view('diagnos.index')->with(compact('legajo','agregar','edicion','active'));    // Abrir form de modificacion
    }
    ...
    public function search(Request $request)
    {
        ...
        $legajos = Sue058::name($request->get('name'))->orderBy('codigo')->paginate(8);
        $name = $request->get('name');

        return view('diagnos.search')->with(compact('legajos','active','name'));
    }
}
