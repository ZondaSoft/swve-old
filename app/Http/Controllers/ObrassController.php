...
class ObrassController extends Controller
{
    ...
    public function index($id = 0)
    {
        ...
        return view('obrass.index')->with(compact('legajo','agregar','edicion','active'));
    }


    public function add()
    {
        $legajo = new Sue009;      // find($id);     // dd($legajo);
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            'codigo'=>'required|unique:sue009s',
        ...
        return redirect('/obrass/' . $legajo->id);
    }
    ...
    public function edit($id)
    {
        ...
        return view('obrass.index')->with(compact('legajo','agregar','edicion','active'));    // Abrir form de modificacion
    }
    ...
    {
        $active = 15;
        //$legajos = Sue009::paginate(8);
        $legajos = Sue009::name($request->get('name'))->orderBy('codigo')->paginate(8);
        $name = $request->get('name');

        return view('obrass.search')->with(compact('legajos','active','name'));
    }
