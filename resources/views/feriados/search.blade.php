...
@section('content')
   ...
   <div class="row">
      <div class="col-lg-9">
        ...
        {!! Form::open(['route' => 'feriados.search' , 'method' => 'GET' , 'class' => 'form-group mb-4' , 'role' => 'search']) !!}
                           ...
                           <td>
                              <div class="media align-items-center">
                                 <div class="media-body d-flex">
                                    <div>
                                       <h5 class="m-0">{{ date("d/m/Y", strtotime($legajo->fecha)) }}</h5>
                                    </div>
                                 </div>
                              </div>
                           </td>
                           ...
                           <td>
                              <div class="media align-items-center">
                                 <div class="media-body d-flex">
                                    ...
                                    <div class="ml-auto">
                                       <a class="btn btn-info btn-sm" href="\feriados\{{ $legajo->id }}" >
                                       Ver detalles</a>
                                    </div>
                                 </div>
                              </div>
