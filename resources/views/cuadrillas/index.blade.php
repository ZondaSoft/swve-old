...
@if($edicion == true)
  @if($agregar == true)
      <form method="post" action="{{ url('/cuadrillas/add') }}" enctype="multipart/form-data">
  @else
      <form method="post" action="{{ url('/cuadrillas/edit/'.$legajo->id) }}" enctype="multipart/form-data">
  @endif
@else
  <form method="post" action="{{ url('/cuadrillas/edit/') }}" enctype="multipart/form-data">
@endif


{{ csrf_field() }}
<div class="content-heading" style="height: 67px;max-height: 90px">
   <div class="col-md-7">Cuadrillas
      <small></small>
   </div>
   ...
   <div class="col-md-4" style="text-align: right;">
      ...
      @else
           <a class="btn btn-oval btn-success" href="/cuadrillas/add" >Agregar</a>
           <a class="btn btn-oval btn-success" href="/cuadrillas/edit/{{ $legajo?$legajo->id:'' }}">Editar</a>
           <a class="btn btn-oval btn-danger" href="/cuadrillas/delete/{{ $legajo?$legajo->id:'' }}">Borrar</a>
      @endif
    </div>
</div>
        ...
        <div class="card-body">
            <div class="col-xl-6">
                ...
                <div class="col-md-10">
                      ...
                      {{ $edicion?'enabled':'disabled' }}
                      value="{{ $legajo?$legajo->encargado:'' }}" autocomplete='off'>
                </div>
                <div class="col-md-10">
                  <p></p>
                  <p></p>
