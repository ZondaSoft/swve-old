...
@if($edicion == true)
  @if($agregar == true)
      <form method="post" action="{{ url('/obrass/add') }}" enctype="multipart/form-data">
  @else
      <form method="post" action="{{ url('/obrass/edit/'.$legajo->id) }}" enctype="multipart/form-data">
  @endif
@else
  <form method="post" action="{{ url('/obrass/edit/') }}" enctype="multipart/form-data">
@endif


{{ csrf_field() }}
<div class="content-heading" style="height: 67px;max-height: 90px">
   <div class="col-md-6">Obras Sociales
      <small></small>
   </div>
   ...
   <div class="col-md-4" style="text-align: right;">
       @if($edicion == true)
           ...
           <a href="{{ url('/obrass') }}" class="btn btn-labeled btn-danger mb-2">
              <span class="btn-label"><i class="fa fa-times"></i>
              </span>Cancelar
           </a>
      @else
           <a class="btn btn-oval btn-success" href="/obrass/add" >Agregar</a>
           <a class="btn btn-oval btn-success" href="/obrass/edit/{{ $legajo?$legajo->id:'' }}">Editar</a>
           <a class="btn btn-oval btn-danger" href="/obrass/delete/{{ $legajo?$legajo->id:'' }}">Borrar</a>
      @endif
    </div>
</div>
                ...
                <div class="col-xl-12 col-md-12">
                 ...
                 <fieldset></fieldset>
                  ...
                  <div class="col-xl-6 col-md-6">
                    <div class="form-row">
                        <div class="col-md-6">
                          <label class="col-form-label">Desde sueldo bruto</label>
                          <input class="form-control" type="number" name="desde_sue1" id="desde_sue1"
                          {{ $edicion?'enabled':'disabled' }}
                          value="{{ old('desde_sue1',$legajo->desde_sue1) }}"
                          maxlength="10" step="0.01">
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="col-xl-6 col-md-6">
                    <div class="form-row">
                        <div class="col-md-6">
                          <label class="col-form-label">Hasta sueldo bruto</label>
                          <input class="form-control" type="number" name="hasta_sue1" id="hasta_sue1"
                          {{ $edicion?'enabled':'disabled' }}
                          value="{{ old('hasta_sue1',$legajo->hasta_sue1) }}"
                          maxlength="10" step="0.01">
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="col-xl-6 col-md-6">
                    <div class="form-row">
                        <div class="col-md-6">
                          <label class="col-form-label">% OOSS</label>
                          <input class="form-control" type="number" name="por_os1" id="por_os1"
                          {{ $edicion?'enabled':'disabled' }}
                          value="{{ old('por_os1',$legajo->por_os1) }}"
                          maxlength="10" step="0.01">
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="col-xl-6 col-md-6">
                    <div class="form-row">
                        <div class="col-md-6">
                          <label class="col-form-label">% Anssal</label>
                          <input class="form-control" type="number" name="por_ans1" id="por_ans1"
                          {{ $edicion?'enabled':'disabled' }}
                          value="{{ old('por_ans1',$legajo->por_ans1) }}"
                          maxlength="10" step="0.01">
                        </div>
                      </div>
                  </div>
               ...
               <div class="card-footer" style="text-align: right;">
                   <div class="col-md-11" style="text-align: right;">
                      ...
                      @else
                           <a class="btn btn-oval btn-success" href="/obrass/add" >Agregar</a>
                           <a class="btn btn-oval btn-success" href="/obrass/edit/{{ $legajo?$legajo->id:'' }}">Editar</a>
                           <a class="btn btn-oval btn-danger" href="/obrass/delete">Borrar</a>
                      @endif
                    </div>
