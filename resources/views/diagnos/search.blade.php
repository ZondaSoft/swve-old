...
@section('content')
   ...
   <div class="content-heading">
      <div>Buscar Patologías Médicas
         <small>Resultados de la búsqueda y filtrado</small>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-9">
        {!! Form::open(['route' => 'diagnos.search' , 'method' => 'GET' , 'class' => 'form-group mb-4' , 'role' => 'search']) !!}
                                 ...
                                 <td>
                                    <div class="media align-items-center">
                                       <div class="media-body d-flex">
                                          ...
                                          <div class="ml-auto">
                                             <a class="btn btn-info btn-sm" href="\diagnos\{{ $legajo->id }}" >
                                             Ver detalles</a>
                                          </div>
                                       </div>
                                    </div>
