...
<div class="content-heading" style="height: 67px;max-height: 90px">
   <div class="col-md-7">Informes de Fichadas
      <small></small>
   </div>
          ...
          <div class="card-body">
              <div class="col-xl-12">
                  <div class="form-row">
                    ...
                    <div class="form-row">
                       <div class="col-lg-4 mb-3">
                          <label class="col-form-label">Desde Sector</label>
                          <select class="form-control" id="sector" name="sector">
                            @foreach ($sectores as $sector)
                                <option value = "{{ old('sector',$sector->codigo) }}">
                                  {{ $sector->codigo  }} - {{ $sector->detalle }} {{ $sector->nombres }}
                                </option>
                            @endforeach
                          </select>
                        </div>
                        ...
                        <div class="col-lg-4 mb-3">
                           <label class="col-form-label" id="lblsector2">Hasta Sector</label>
                           <select class="form-control" id="sector2" name="sector2">
                             @foreach ($sectores as $sector)
                                 <option value = "{{ old('sector2',$sector->codigo) }}">
                                   {{ $sector->codigo  }} - {{ $sector->detalle }} {{ $sector->nombres }}
                                 </option>
                             @endforeach
                           </select>
