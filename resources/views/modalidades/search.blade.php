...
@section('content')
   ...
   <div class="content-heading">
      <div>Buscar modalidades de contratación
         <small>Resultados de la búsqueda y filtrado</small>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-9">
        {!! Form::open(['route' => 'modalidades.search' , 'method' => 'GET' , 'class' => 'form-group mb-4' , 'role' => 'search']) !!}
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="media align-items-center">
                                 <div class="media-body d-flex">
                                    <div>
                                       <h5 class="m-0">{{ $legajo->detalle }}</h5>
                                    </div>
                                    <div class="ml-auto">
                                       <a class="btn btn-info btn-sm" href="\modalidades\{{ $legajo->id }}" >
                                       Ver detalles</a>
                                    </div>
                                 </div>
                              </div>
