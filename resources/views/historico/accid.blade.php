        ...
        <div class="row">
           <div class="col-lg-8">
             <div class="form-group mb-4">
                 <input class="form-control mb-2" type="text" placeholder="Buscar (Legajo, Apellido y Nombre, Nro.Siniestro)...">
                 <div class="d-flex">
            ...
            <div class="col-lg-4">
              <div class="ml-auto">
                 <label class="c-checkbox" style="padding-top: 7px">
                    <input id="inlineCheckbox10" type="checkbox" value="option1" checked>
                    <span class="fa fa-check"></span>Ver cerrados</label>
                 <label class="c-checkbox">
                    <input id="inlineCheckbox20" type="checkbox" value="option2" checked>
                    <span class="fa fa-check"></span>Ver abiertos</label>
              </div>
          </div>
        </div>
                             ...
                             <div class="media align-items-center">
                                <div class="media-body d-flex">
                                   <div>
                                      @IF ($novedad->estado == "A")
                                         Abierto
                                      @ELSEIF ($novedad->estado == "M")
                                         Alta Médica
                                      @ELSEIF ($novedad->estado == "R")
                                         Rechazada
                                      @ELSE
                                         Pendiente
                                      @ENDIF
