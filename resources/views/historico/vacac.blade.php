        ...
        <div class="row">
           <div class="col-lg-8">
             <div class="form-group mb-4">
                 <input class="form-control mb-2" type="text" placeholder="Buscar (Legajo, Apellido y Nombre, Sector)...">
                 <div class="d-flex">
            ...
            <div class="col-lg-4">
              <div class="ml-auto">
                 <label class="c-checkbox" style="padding-top: 7px">
                    ...
                    <span class="fa fa-check"></span>Ver todos</label>
                 <label class="c-checkbox">
                    <input id="inlineCheckbox20" type="checkbox" value="option2" checked>
                    <span class="fa fa-check"></span>Ver solo vacaciones pendientes</label>
              </div>
          </div>
        </div>
