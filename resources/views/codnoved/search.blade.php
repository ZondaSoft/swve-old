...
@section('content')
   ...
   <div class="content-heading">
      <div>Buscar códigos de novedades
         <small>Resultados de la búsqueda y filtrado</small>
      </div>
   </div>
   <div class="row">
      <div class="col-lg-9">
        {!! Form::open(['route' => 'codnoved.search' , 'method' => 'GET' , 'class' => 'form-group mb-4' , 'role' => 'search']) !!}
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <div class="media align-items-center">
                                       <div class="media-body d-flex">
                                          <div>
                                             <h4 class="m-0">{{ $legajo->codigo2 }}</h4>
                                          </div>
                                 ...
                                 <td>
                                    <div class="media align-items-center">
                                       <div class="media-body d-flex">
                                          ...
                                          <div class="ml-auto">
                                             <a class="btn btn-info btn-sm" href="\codnoved\{{ $legajo->id }}" >
                                             Ver detalles</a>
                                          </div>
                                       </div>
                                    </div>
